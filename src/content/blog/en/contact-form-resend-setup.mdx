...
description: "Astro Rocket's contact form is wired up but needs three things to actually deliver email: a Resend account, a verified domain, and one environment variable on Vercel."
...
<PlaceholderImage icon="mail-check" caption="Domain verified in the Resend dashboard" />
